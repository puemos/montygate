 ...
 *
 * This shows how to convert registered tools into Vercel AI-compatible
 * tool definitions for use with generateText() or streamText().
 */
...
engine.tool("create_summary", {
  description: "Create a summary of given text",
  params: z.object({ text: z.string(), maxWords: z.number().optional() }),
  run: async ({ text, maxWords }) => ({
